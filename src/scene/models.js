...
export const TILE_MODELS = {
  ...
  skating:   { url: '/models/konki2.glb',      hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  ...
  bike:      { url: '/models/bike.glb',        hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  music:     { url: '/models/music.glb',       hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  gift:      { url: '/models/gift.glb',        hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  dinner:    { url: '/models/yzhin.glb',       hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  spontan:   { url: '/models/spontanno.glb',   hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  nature:    { url: '/models/priroda.glb',     hideBase: true, yOffset: 0.6, scaleMul: 0.72 },

...
export const TILE_MODELS = {
  ...
  play:      { url: '/models/play0.glb',       hideBase: true, yOffset: 0.6 },
  kitchen:   { url: '/models/kitchen0.glb',    hideBase: true, yOffset: 0.6 },
  skating:   { url: '/models/konki.glb',       hideBase: true, yOffset: 0.6 },
  proposal:  { url: '/models/Predlozhenie.glb', hideBase: true, yOffset: 0.6 },
  fooling:   { url: '/models/durachilis.glb',  hideBase: true, yOffset: 0.6 },
  quest:     { url: '/models/kvest.glb',       hideBase: true, yOffset: 0.6 },
  rain:      { url: '/models/rain.glb',        hideBase: true, yOffset: 0.6 },
  beach:     { url: '/models/beach.glb',       hideBase: true, yOffset: 0.6 },
  hike:      { url: '/models/pohod.glb',       hideBase: true, yOffset: 0.6 },
  movein:    { url: '/models/house.glb',       hideBase: true, yOffset: 0.6 },
  pet:       { url: '/models/cat.glb',         hideBase: true, yOffset: 0.6 },

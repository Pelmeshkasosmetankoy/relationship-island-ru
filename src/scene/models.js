...
export const TILE_MODELS = {
  ...
  skating:   { url: '/models/konki2.glb',      hideBase: true, yOffset: 0.6, scaleMul: 0.85 },
  ...
  bike:      { url: '/models/bike.glb',        hideBase: true, yOffset: 0.6, scaleMul: 0.85 },
  music:     { url: '/models/music.glb',       hideBase: true, yOffset: 0.6, scaleMul: 0.85 },
  ...
  nature:    { url: '/models/priroda.glb',     hideBase: true, yOffset: 0.6, scaleMul: 0.85 },

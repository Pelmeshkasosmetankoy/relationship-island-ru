...
export const TILE_MODELS = {
  ...
  hike:      { url: '/models/pohod.glb',       hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  movein:    { url: '/models/house.glb',       hideBase: true, yOffset: 0.6, scaleMul: 0.72 },
  pet:       { url: '/models/cat.glb',         hideBase: true, yOffset: 0.6, scaleMul: 0.72 },

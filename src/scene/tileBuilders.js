...
export const TYPES = [
  ...
  { key:'skating',   label:'Катались на коньках',          color:'#8fd6e8', icon:'⛸️', iconPath:'/event-icons/skate.svg' },
  ...
  { key:'rain',      label:'Попали под дождь',             color:'#8ea0bd', icon:'🌧️', iconPath:'/event-icons/rain.svg' },
  { key:'beach',     label:'Были на пляже',                color:'#e8d79a', icon:'🏖️', iconPath:'/event-icons/beach.svg' },
  { key:'hike',      label:'Сходили в поход',              color:'#5f9a4a', icon:'⛺' },
  { key:'movein',    label:'Съехались',                    color:'#d0a878', icon:'🏡', iconPath:'/event-icons/house.svg' },
  { key:'pet',       label:'Завели питомца',               color:'#c98f5c', icon:'🐾' },
  { key:'bike',      label:'Катались на велосипеде',       color:'#6fa85a', icon:'🚴', iconPath:'/event-icons/bike.svg' },
  { key:'gift',      label:'Подарили подарки',             color:'#d05a6a', icon:'🎁', iconPath:'/event-icons/gift.svg' },
  { key:'dinner',    label:'Вкусно поели',                 color:'#d07a96', icon:'🍽️', iconPath:'/event-icons/candle.svg' },
  { key:'spontan',   label:'Что-то спонтанное',            color:'#e0b84a', icon:'⚡', iconPath:'/event-icons/lightning.svg' },
  { key:'nature',    label:'Провели время на природе',     color:'#6fae55', icon:'🌿' },
  { key:'newthing',  label:'Попробовали что-то новое',     color:'#9a7ad0', icon:'✨', iconPath:'/event-icons/rostoc.svg' },
  { key:'buy',       label:'Купили что-то вместе',         color:'#d88a5a', icon:'🛍️' },
  { key:'picnic',    label:'Пикник вместе',                color:'#8fc24a', icon:'🧺' },
  { key:'prazdnik',  label:'Отметили праздник',            color:'#b187d6', icon:'🎊', iconPath:'/event-icons/party.svg' },
